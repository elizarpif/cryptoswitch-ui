...
func (this *UICryptoswitchMainWindow) SetupUI(MainWindow *widgets.QMainWindow) {
	...
	this.LabelCountPlainText.SetGeometry(core.NewQRect4(20, 150, 261, 21))
	...
	this.LabelCountCipherText.SetGeometry(core.NewQRect4(20, 320, 261, 21))
	...
	this.SelectInFileBtn.SetGeometry(core.NewQRect4(290, 50, 221, 41))
	this.LabelInFile = widgets.NewQLabel(this.File, core.Qt__Widget)
	this.LabelInFile.SetObjectName("LabelInFile")
	this.LabelInFile.SetGeometry(core.NewQRect4(40, 60, 251, 21))
	font = gui.NewQFont()
	font.SetFamily("Ubuntu Mono derivative Powerline")
	...
	this.LabelOutFile.SetGeometry(core.NewQRect4(40, 110, 251, 21))
	font = gui.NewQFont()
	font.SetFamily("Ubuntu Mono derivative Powerline")
	...
	this.SelectOutFileBtn.SetGeometry(core.NewQRect4(290, 100, 221, 41))
