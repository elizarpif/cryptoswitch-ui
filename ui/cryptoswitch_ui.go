...
func (this *UICryptoswitchMainWindow) SetupUI(MainWindow *widgets.QMainWindow) {
	...
	this.CipherSwitch.SetGeometry(core.NewQRect4(400, 50, 241, 26))
	...
	this.LabelCipherMode.SetGeometry(core.NewQRect4(400, 90, 171, 21))
	font = gui.NewQFont()
	font.SetFamily("Ubuntu Mono derivative Powerline")
	font.SetPointSize(14)
	...
	this.ParamsGroup.SetGeometry(core.NewQRect4(60, 20, 251, 201))
	font = gui.NewQFont()
	font.SetFamily("Ubuntu Mono derivative Powerline")
	font.SetPointSize(14)
	...
	this.GenerateBtn.SetGeometry(core.NewQRect4(50, 230, 271, 41))
	...
	this.SecretKey.SetGeometry(core.NewQRect4(400, 240, 241, 21))
	font = gui.NewQFont()
	font.SetPointSize(14)
	this.SecretKey.SetFont(font)
	this.SecretKey.SetEchoMode(widgets.QLineEdit__Normal)
	this.SecretKey.SetReadOnly(true)
	this.LabelSecretKey = widgets.NewQLabel(this.Centralwidget, core.Qt__Widget)
	this.LabelSecretKey.SetObjectName("LabelSecretKey")
	this.LabelSecretKey.SetGeometry(core.NewQRect4(400, 210, 171, 21))
	font = gui.NewQFont()
	font.SetFamily("Ubuntu Mono derivative Powerline")
	font.SetPointSize(14)
	...
	this.GroupBox.SetGeometry(core.NewQRect4(400, 120, 241, 80))
	this.GcmRadio = widgets.NewQRadioButton(this.GroupBox)
	this.GcmRadio.SetObjectName("GcmRadio")
	this.GcmRadio.SetGeometry(core.NewQRect4(10, 10, 100, 20))
	font = gui.NewQFont()
	font.SetFamily("Ubuntu Mono derivative Powerline")
	font.SetPointSize(14)
	...
	this.CbcRadio.SetGeometry(core.NewQRect4(10, 40, 100, 20))
	font = gui.NewQFont()
	font.SetFamily("Ubuntu Mono derivative Powerline")
	font.SetPointSize(14)
